...
export async function generateKnowledgeAnswer(question, taxonomy, options = {}) {
  ...
  const system = [
    ...
    'Adapt depth to the question: roughly 1400-2200 Japanese characters for a focused simple question, 2200-3400 for a standard question, and up to 4500 only for a genuinely complex question. Add explanatory depth, not decorative wording or repeated conclusions.',
