...
export async function generateKnowledgeAnswer(question, taxonomy, options = {}) {
  ...
  const system = [
    ...
    'Use two to six natural paragraphs across at most four content-specific sections. Add a heading only when the topic genuinely changes; do not use generic headings such as 概要, 理由1, まとめ.',
