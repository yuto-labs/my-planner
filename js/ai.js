...
export async function generateKnowledgeAnswer(question, taxonomy, options = {}) {
  ...
  const system = [
    ...
    'Target roughly 1300-2200 Japanese characters. Prioritize a complete, accurate explanation over merely reaching a length target.',
    ...
    'For historical questions, make chronology and causal relationships explicit. For scientific or technical questions, explain the mechanism and its limits. For abstract concepts, contrast the concept with its nearest confusing alternatives.',
    'Use two to six natural paragraphs across two to four content-specific sections. Keep each paragraph focused on one connected idea so the answer remains easy to scan.',
    'Organize the sections around the subject itself: establish the premise, explain the mechanism or causal flow, then use a concrete example or comparison. Add limits or exceptions only when they genuinely matter.',
