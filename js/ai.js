...
export async function generateKnowledgeAnswer(question, taxonomy, options = {}) {
  ...
  const system = [
    ...
    'Use marks sparingly: strong for essential terms, one to three highlights across the whole answer, warning only for a real caveat. Never highlight an entire paragraph.',
