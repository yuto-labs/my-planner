        ...
        entries: {
          ...
          items: {
            ...
            properties: {
              ...
              collocations: {
                type: 'ARRAY',
                description: 'Common short collocations with a Japanese meaning, a practical usage boundary, and one or two natural examples whose Japanese translations are idiomatic rather than forced to repeat the topic gloss.',
                maxItems: 8,
                items: {
                  type: 'OBJECT',
                  properties: {
...
function buildBlockedRetryInstruction(actionType) {
  if (actionType === 'knowledge_answer') {
    return [
      ...
      'Use richBlocks only when useful. Do not output Markdown or HTML. Use segment marks semantically: strong for a defining term, highlight-yellow for a core mechanism or causal relation, highlight-blue for a contrast or condition, and warning only for a real caveat. Keep every marked span short.',
